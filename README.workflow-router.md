...
Optional `role_base_url` lets the router call the local model or gateway for a schema-validated advisory classification. Deterministic safety rules still win.
