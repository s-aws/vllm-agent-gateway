#!/usr/bin/env python3
"""Validate Phase 261 live acceptance for the 384k large-context target."""
...
from vllm_agent_gateway.acceptance.large_context_384k_live_acceptance import (  # noqa: E402
...
def main() -> int:
    ...
    print(
        "PHASE261 LARGE CONTEXT 384K LIVE ACCEPTANCE SUMMARY "
        + json.dumps(report.get("summary", {}), ensure_ascii=True, sort_keys=True)
    )
    if report["status"] != LargeContext384kLiveAcceptanceStatus.PASSED.value:
        print("PHASE261 LARGE CONTEXT 384K LIVE ACCEPTANCE FAIL")
        print("PHASE261 ERRORS " + json.dumps(report.get("errors", []), ensure_ascii=True, sort_keys=True))
        return 1
    print("PHASE261 LARGE CONTEXT 384K LIVE ACCEPTANCE PASS")
    return 0
