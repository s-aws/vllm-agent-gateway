#!/usr/bin/env python3
"""Validate Phase 276 500k candidate decision gate."""
...
from vllm_agent_gateway.acceptance.large_context_500k_candidate_decision_gate import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--phase275-report-path", default=str(DEFAULT_PHASE275_REPORT_PATH))
...
def main() -> int:
    ...
    report = validate_large_context_500k_candidate_decision_gate(
        LargeContext500kCandidateDecisionGateConfig(
            ...
            phase275_report_path=Path(args.phase275_report_path),
    ...
    print(
        "PHASE276 LARGE CONTEXT 500K CANDIDATE DECISION GATE SUMMARY "
        + json.dumps(
            {
                ...
                "phase275_status": report["summary"]["phase275_status"],
                "phase275_decision": report["summary"]["phase275_decision"],
                "candidate_estimated_project_tokens": report["summary"]["candidate_estimated_project_tokens"],
                "phase277_ready": report["summary"]["phase277_ready"],
            },
            ensure_ascii=True,
            sort_keys=True,
        )
    )
    print("PHASE276 LARGE CONTEXT 500K CANDIDATE DECISION GATE PASS")
    return 0
