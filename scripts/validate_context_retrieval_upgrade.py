#!/usr/bin/env python3
"""Validate Phase 95 context-retrieval upgrade."""
...
from vllm_agent_gateway.acceptance.context_retrieval_upgrade import (  # noqa: E402
...
def main() -> int:
    ...
    print(f"CONTEXT RETRIEVAL UPGRADE REPORT {report['report_path']}")
    print(
        "CONTEXT RETRIEVAL UPGRADE SUMMARY "
        + json.dumps(
            {
                ...
                "port_health_enabled": report.get("summary", {}).get("port_health_enabled"),
            },
            ensure_ascii=True,
            sort_keys=True,
        )
    ...
    if report["status"] != "passed":
        ...
        print("CONTEXT RETRIEVAL UPGRADE FAILURES " + json.dumps(failures, ensure_ascii=True, sort_keys=True))
        return 1
    print("CONTEXT RETRIEVAL UPGRADE PASS")
    return 0
