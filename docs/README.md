...
- [Connector Catalog README](../README.connector-catalog.md): Phase 287 governed connector manifest validation, approval-gated registration, enabled local-stub mediation, actor-bound invocation, user-scope enforcement, and replay-safe audit proof for external integration contracts.
...
- [Large-Context 384k Objective Rebaseline README](../README.large-context-384k-objective-rebaseline.md): Phase 251 static gate that keeps the active large-context release target at 384k-token project usability.
- [Large-Context 384k Usability Acceptance Contract README](../README.large-context-384k-usability-acceptance-contract.md): Phase 258 executable contract for the current 384k product target before fixture/index readiness, stale-index rejection, and live acceptance.
- [Large-Context 384k Fixture And Index Readiness README](../README.large-context-384k-fixture-index-readiness.md): Phase 259 composed readiness gate over Phase 214, Phase 216, and Phase 217 before stale-index rejection and live 384k acceptance.
...
- [Large-Context 500k Answer-Quality Repair README](../README.large-context-500k-answer-quality-repair.md): Phase 274 repair/no-repair closure gate over the Phase 273 live acceptance report.
- [Large-Context 500k Clean Clone Replay README](../README.large-context-500k-clean-clone-replay.md): Phase 275 remote branch clone replay for the complete 500k candidate proof chain.
...
- [Supplied Corpus QA README](../README.supplied-corpus-qa.md): Phase 280 first-class inline supplied-corpus QA route for evidence-only synthesis, precedence, boundary stitching, calculations, and contradiction handling.
...
- [Release-Candidate Runtime Health Restoration README](../README.release-candidate-runtime-health-restoration.md): Phase 245 post-restart runtime health proof before rerunning the release decision.
- [Release-Candidate Ship Handoff README](../README.release-candidate-ship-handoff.md): Phase 247 committed ship handoff metadata and tester-doc freshness gate.
...
- [Large-Context 384k Objective Rebaseline Examples](examples/large-context-384k-objective-rebaseline.md)
- [Large-Context 384k Usability Acceptance Contract Examples](examples/large-context-384k-usability-acceptance-contract.md)
- [Large-Context 384k Fixture And Index Readiness Examples](examples/large-context-384k-fixture-index-readiness.md)
...
- [Large-Context 500k Answer-Quality Repair Examples](examples/large-context-500k-answer-quality-repair.md)
...
- [Release-Candidate Ship Handoff Examples](examples/release-candidate-ship-handoff.md)
