...
| P0-M14-245 | Release-candidate runtime health restoration | Approved in Phase 245. Restore vLLM and full featured-port health for the release-candidate stack. | Required proof: localhost `8000`, gateway, controller, workflow-router gateway, role proxy ports, AnythingLLM target, minimal gateway/AnythingLLM read-only prompt, and protected fixture mutation check. |
| P0-M14-246 | Release-candidate decision rerun after runtime health | Approved in Phase 246. Rerun the Phase 244 decision gate after health restoration. | Required proof: live Phase 244 rerun with no stale runtime caveat; ship/hold/repair decision tied to fresh evidence. |
