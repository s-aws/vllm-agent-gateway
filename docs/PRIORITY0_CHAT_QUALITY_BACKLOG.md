...
| P0-M15-275 | clean-clone 500k candidate replay | Complete in Phase 275. Replayed the 500k candidate path from a fresh remote branch clone without active workspace state. | Proof: Phase 275 policy, validator, docs, remote clone source checks, Phase 270 through Phase 274 replay, live gateway, live AnythingLLM, clone clean before/after, focused regression `10 passed`, docs index `363` linked docs and zero orphaned docs, and clean-clone proof. |
...
`P0-M15-275` completed in Phase 275. It replays Phase 270 through Phase 274 from a fresh remote branch clone and requires the clone to remain clean before and after validation with `runtime-state/` ignored. Preliminary focused regression passed with `10 passed`; docs index validation passed with `363` linked docs and zero orphaned docs. It does not promote 500k to stable; Phase 276 decision remains required.
