# Multi-Repo Baseline Comparison Examples
...
wsl.exe --cd /mnt/c/agentic_agents -- bash -lc "python3 scripts/validate_multi_repo_baseline_comparison.py --live --timeout-seconds 900"
```
...
report = json.loads(Path("runtime-state/phase210/phase210-multi-repo-baseline-comparison-report.json").read_text())
